...
import com.algonquincollege.cst8284.assignment2.model.FireElemental;
import com.algonquincollege.cst8284.assignment2.model.TrollBeast;
 ...
 * @author piedas, updated by Si Lin
 *
 */
public class CharacterGame {
	...
	public CharacterGame() {
		for(int index = 0; index < characters.length-5; index++) {
			characters[index] = new FireElemental();
			
		}
		for(int index = 5; index < characters.length; index++) {
			
			characters[index] = new TrollBeast();
		}
